...
class _DizimistaViewState extends State<DizimistaView> {
                        ...
                        children: [
                          Expanded(
                            child: TextField(
                              ...
                              inputFormatters: [cpfFormatter], // Aplica a máscara de CPF
                          ...
                          Expanded(
                            child: TextField(
                              ...
                              inputFormatters: [telefoneFormatter], // Aplica a máscara de telefone
  ...
  void _showEditarDialog(BuildContext context, Dizimista dizimista) {
    ...
    final enderecoController = TextEditingController(text: dizimista.endereco);
